...
class BaseUser(BaseModel):
    ...
    def validate_full_name(cls, v):
        try:
            ...
            raise ValueError("You need to provide at least two names")
...
class CustomHTTPBearer(HTTPBearer):
    async def __call__(
        ...
        try:
            ...
            # Want to bind our user to the request so that it can be globally useable
...
async def create_clothes(clothes_data: ClothesIn):
    ...
    return await database.fetch_one(clothes.select().where(clothes.c == id_))
